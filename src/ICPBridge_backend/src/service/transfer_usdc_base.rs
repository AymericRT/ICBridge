...
use alloy::{
    ...
    signers::{k256::elliptic_curve::consts::U25, Signer},
    sol,
    transports::icp::IcpConfig,
};

use crate::{create_icp_signer, get_rpc_service_basesepolia};
...
pub async fn transfer_usdc_base(to: Address, value: U256) -> Result<String, String> {
    // Sanitize input
